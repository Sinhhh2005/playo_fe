        ...
        <CardContent className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-3 gap-4 items-center">
            ...
            <div className="col-span-2">
              <Select
				value={selectedSport}
				onValueChange={(value: string) => setSelectedSport(value as SportKey)}
				>
                    ...
                    {generateCalendarDays().map((day) => (
                      <button
                        ...
                        className={`p-2 rounded-full hover:bg-gray-100 ${
                          day === 5 ? "bg-green-500 text-white hover:bg-green-600" : ""
                        }`}
                        onClick={() => {
                          setSelectedDate(
                            `2025-10-${day.toString().padStart(2, "0")}`
                          );
                    ...
                    {courts.map((court) => (
                      <SelectItem key={court.id} value={court.id}>
                        <div className="flex justify-between w-full">
                          ...
                          <span className="text-gray-500 ml-4">INR {court.price}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
          ...
          <div className="pt-6">
            <Button
              ...
              disabled={
                selectedSport === "swimming" ? ticketCount === 0 : !selectedCourt
              }
            >
              Add To Cart
            </Button>
